...
var ToolAddCommand = /** @class */ (function (_super) {
    __extends(ToolAddCommand, _super);
    function ToolAddCommand() {
        var _this = _super.call(this, 'addTool', '/tools', api_command_1.RequestType.POST, '/', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Adds a new tool.';
    ...
    ToolAddCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.addTool(body)];
                    case 2:
                        result = _a.sent();
                        if (result.length === 1) {
    ...
    return ToolAddCommand;
}(api_command_1.ApiCommand));
exports.ToolAddCommand = ToolAddCommand;
