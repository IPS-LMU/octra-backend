...
exports.MediaAddCommand = void 0;
...
var MediaAddCommand = /** @class */ (function (_super) {
    __extends(MediaAddCommand, _super);
    function MediaAddCommand() {
        var _this = _super.call(this, 'addMediaItem', '/media', api_command_1.RequestType.POST, '/', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Adds a new media item.';
        _this._acceptedContentType = 'application/json';
        _this._responseContentType = 'application/json';
        // relevant for reference creation
        _this._requestStructure = {
            properties: __assign(__assign({}, _this.defaultRequestSchema.properties), { url: {
                    type: 'string',
                    required: true
                }, type: {
                    type: 'string'
    ...
    MediaAddCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.addMediaItem(body)];
                    case 2:
                        result = _a.sent();
                        if (result.length === 1) {
                        ...
                        api_command_1.ApiCommand.sendError(res, server_codes_1.InternalServerError, 'Could not add media item.');
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
    ...
    return MediaAddCommand;
}(api_command_1.ApiCommand));
exports.MediaAddCommand = MediaAddCommand;
