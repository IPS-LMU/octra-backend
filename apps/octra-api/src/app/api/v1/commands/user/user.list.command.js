...
var UserListCommand = /** @class */ (function (_super) {
    __extends(UserListCommand, _super);
    function UserListCommand() {
        var _this = _super.call(this, 'listUsers', '/users', api_command_1.RequestType.GET, '/', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Returns a list of users.';
    ...
    UserListCommand.prototype["do"] = function (req, res) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        _a = answer;
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.listUsers()];
                    case 2:
                        _a.data = _b.sent();
