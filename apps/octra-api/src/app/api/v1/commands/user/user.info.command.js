...
var UserInfoCommand = /** @class */ (function (_super) {
    __extends(UserInfoCommand, _super);
    function UserInfoCommand() {
        var _this = _super.call(this, 'getUserInformation', '/users', api_command_1.RequestType.GET, '/:id', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Retrieves information about a user by id.';
    ...
    UserInfoCommand.prototype["do"] = function (req, res) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        _a = answer;
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.getUserInfoByUserID(req.params.id)];
                    case 2:
                        _a.data = _b.sent();
                        if (answer.data.hash) {
