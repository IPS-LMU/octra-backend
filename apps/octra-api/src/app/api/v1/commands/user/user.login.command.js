...
exports.UserLoginCommand = void 0;
...
var UserLoginCommand = /** @class */ (function (_super) {
    __extends(UserLoginCommand, _super);
    function UserLoginCommand() {
        var _this = _super.call(this, 'loginUser', '/users', api_command_1.RequestType.POST, '/login', false, []) || this;
        _this._description = 'Login a user';
        _this._acceptedContentType = 'application/json';
        _this._responseContentType = 'application/json';
        // relevant for reference creation
        _this._requestStructure = __assign(__assign({}, _this.defaultRequestSchema), { type: 'object', properties: __assign(__assign({}, _this.defaultRequestSchema.properties), { type: {
        ...
        _this._responseStructure = {
            properties: __assign(__assign({ token: {
                    type: 'string',
    ...
    UserLoginCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var validation, body, answer, authenticated, authenticator, userData, hash, passwordIsValid, id, username, role, tokenData, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.getUserInfo({
                                name: body.name,
                                hash: authenticator.uid
                            })];
                    case 2:
                        userData = _a.sent();
                        if (!(authenticator.isActive || body.type === 'shibboleth')) return [3 /*break*/, 4];
                    ...
                    case 4:
                        if (userData === null || userData === undefined) {
                            api_command_1.ApiCommand.sendError(res, 401, 'Can not find user.', false);
                            return [2 /*return*/];
                        }
                        hash = userData.hash;
                        passwordIsValid = database_functions_1.DatabaseFunctions.getPasswordHash(body.password) === hash;
                        if (!passwordIsValid) {
                            api_command_1.ApiCommand.sendError(res, 401, 'Invalid password.', false);
                            return [2 /*return*/];
                        }
                        authenticated = true;
                        _a.label = 5;
...
exports.UserLoginCommand = UserLoginCommand;
