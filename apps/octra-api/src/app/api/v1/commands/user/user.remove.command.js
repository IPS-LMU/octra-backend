...
exports.UserRemoveCommand = void 0;
...
var UserRemoveCommand = /** @class */ (function (_super) {
    __extends(UserRemoveCommand, _super);
    function UserRemoveCommand() {
        var _this = _super.call(this, 'removeUser', '/users', api_command_1.RequestType.DELETE, '/:id', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Removes a user by id.';
    ...
    UserRemoveCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.removeUserByID(req.params.id)];
                    case 2:
                        _a.sent();
                        answer.data = {};
...
exports.UserRemoveCommand = UserRemoveCommand;
