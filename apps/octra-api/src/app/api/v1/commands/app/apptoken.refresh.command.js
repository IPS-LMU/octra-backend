...
exports.AppTokenRefreshCommand = void 0;
...
var AppTokenRefreshCommand = /** @class */ (function (_super) {
    __extends(AppTokenRefreshCommand, _super);
    function AppTokenRefreshCommand() {
        var _this = _super.call(this, 'refreshAppToken', '/app', api_command_1.RequestType.PUT, '/tokens/:id/refresh', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Generates a new app token and replaces the old one.';
    ...
    AppTokenRefreshCommand.prototype["do"] = function (req, res) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 4]);
                        _a = answer;
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.refreshAppToken(req.params.id)];
                    case 2:
                        _a.data = _b.sent();
    ...
    return AppTokenRefreshCommand;
}(api_command_1.ApiCommand));
exports.AppTokenRefreshCommand = AppTokenRefreshCommand;
