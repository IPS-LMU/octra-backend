...
exports.AppTokenCreateCommand = void 0;
...
var AppTokenCreateCommand = /** @class */ (function (_super) {
    __extends(AppTokenCreateCommand, _super);
    function AppTokenCreateCommand() {
        var _this = _super.call(this, 'createAppToken', '/app', api_command_1.RequestType.POST, '/tokens/', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Registers an app and returns a new App Token.';
    ...
    AppTokenCreateCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.createAppToken(body)];
                    case 2:
                        result = _a.sent();
                        if (result.length === 1) {
                        ...
                        api_command_1.ApiCommand.sendError(res, server_codes_1.InternalServerError, 'Could not create app token.');
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
    ...
    return AppTokenCreateCommand;
}(api_command_1.ApiCommand));
exports.AppTokenCreateCommand = AppTokenCreateCommand;
