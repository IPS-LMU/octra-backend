...
exports.AppTokenRemoveCommand = void 0;
...
var AppTokenRemoveCommand = /** @class */ (function (_super) {
    __extends(AppTokenRemoveCommand, _super);
    function AppTokenRemoveCommand() {
        var _this = _super.call(this, 'removeAppToken', '/app', api_command_1.RequestType.DELETE, '/tokens/:id', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Removes an app token.';
        ...
        _this._responseStructure = {
            properties: __assign({}, _this.defaultResponseSchema.properties)
        };
        return _this;
    }
    AppTokenRemoveCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var answer, validation, e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.removeAppToken(req.params.id)];
                    case 2:
                        _a.sent();
    ...
    return AppTokenRemoveCommand;
}(api_command_1.ApiCommand));
exports.AppTokenRemoveCommand = AppTokenRemoveCommand;
