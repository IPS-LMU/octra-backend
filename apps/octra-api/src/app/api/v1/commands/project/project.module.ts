...
import {TasksGetCommand} from './tasks/tasks.get.command';
...
import {TaskUploadCommand} from './tasks/task.upload.command';
import {ProjectTranscriptGetCommand} from './tasks/task.get.command';
import {ProjectTranscriptsChangeStatusCommand} from './tasks/task.change.status.command';
