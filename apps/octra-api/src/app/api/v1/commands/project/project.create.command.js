...
var ProjectCreateCommand = /** @class */ (function (_super) {
    __extends(ProjectCreateCommand, _super);
    function ProjectCreateCommand() {
        var _this = _super.call(this, 'createProject', '/projects', api_command_1.RequestType.POST, '/', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'Creates a new transcription project.';
    ...
    ProjectCreateCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, database_functions_1.DatabaseFunctions.createProject(body)];
                    case 2:
                        result = _a.sent();
                        if (result.length === 1) {
                        ...
                        api_command_1.ApiCommand.sendError(res, server_codes_1.InternalServerError, 'Could not create project.');
                        return [3 /*break*/, 4];
                    case 3:
                        e_1 = _a.sent();
