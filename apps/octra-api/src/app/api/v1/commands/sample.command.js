...
var SampleCommand = /** @class */ (function (_super) {
    ...
    function SampleCommand() {
        var _this = _super.call(this, 'commandName', 'parent', api_command_1.RequestType.POST, '/v1/commandURI', true, [
            database_types_1.UserRole.administrator
        ]) || this;
        _this._description = 'ADD YOUR DESCRIPTION HERE';
        _this._acceptedContentType = 'application/json';
        _this._responseContentType = 'application/json';
        // relevant for reference creation
        _this._requestStructure = {
            properties: __assign({}, _this.defaultRequestSchema.properties)
        };
        // relevant for reference creation
    ...
    SampleCommand.prototype["do"] = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var answer, validation;
            return __generator(this, function (_a) {
                answer = api_command_1.ApiCommand.createAnswer();
                validation = this.validate(req.params, req.body);
                // do something
                if (validation.length === 0) {
                    return [2 /*return*/, res.status(success_codes_1.OK).send(answer)];
                }
                else {
