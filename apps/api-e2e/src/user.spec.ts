...
describe('OCTRA Nest API user (e2e)', () => {
  beforeEach(async () => {
    ...
    await app.init();
    TestCases.init(AccountRole.user, app);
  });
  ...
  describe('Authentication', () => {
    ...
    it('/auth/login (POST)', TestCases.authenticate);
  });
  ...
  describe('Projects', () => {
    ...
    it('/projects/ (POST)', () => TestCases.createNewProject(AccountRole.administrator));
    ...
    it('/projects/:project_id/tasks (POST) (transcript file, JSON)', () => TestCases.uploadTaskDataWithTranscriptFileJSON(AccountRole.administrator));
    it('/projects/:project_id/tasks/:task_id (PUT) without inputs', () => TestCases.changeTaskDataWithoutInputs(AccountRole.administrator));
