...
export class TaskInputOutputEntity {
  ...
  'filename'?: string;
  'url'?: string;
  'content_type'?: TaskInputOutputEntityContentTypeEnum;
  'content'?: string;
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    },
    {
      ...
      'type': 'TaskInputOutputEntityContentTypeEnum',
      'format': ''
    },
    {
      'name': 'content',
...
export type TaskInputOutputEntityContentTypeEnum = 'Text' | 'AnnotJSON' | 'Textgrid';
