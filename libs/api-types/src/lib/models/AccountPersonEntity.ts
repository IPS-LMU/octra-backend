...
export class AccountPersonEntity {
  'username'?: string;
  'email'?: string;
  'loginmethod': any;
  'active': boolean;
  'hash'?: string;
  'gender': AccountPersonEntityGenderEnum;
  'first_name': string;
  'last_name': string;
  'organization': string;
  'birthday': Date;
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    },
    {
      'name': 'gender',
      'baseName': 'gender',
      'type': 'AccountPersonEntityGenderEnum',
      'format': ''
    },
    {
      'name': 'first_name',
  ...
  static getAttributeTypeMap() {
    return AccountPersonEntity.attributeTypeMap;
  }
...
export type AccountPersonEntityGenderEnum = 'male' | 'female' | 'divers';
