...
export class GeneralSettingsDto {
  ...
  'data_policy_urls'?: Array<LanguageURLMapping>;
  'terms_conditions_urls'?: Array<LanguageURLMapping>;
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    },
    {
      ...
      'baseName': 'data_policy_urls',
      'type': 'Array<LanguageURLMapping>',
      'format': ''
    },
    {
      'name': 'terms_conditions_urls',
      'baseName': 'terms_conditions_urls',
      'type': 'Array<LanguageURLMapping>',
      'format': ''
    }];
