...
export class SaveAnnotationDto {
  ...
  'log'?: Array<any>;
  'transcript'?: string;
  'content_type'?: SaveAnnotationDtoContentTypeEnum;
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    },
    {
      ...
      'type': 'SaveAnnotationDtoContentTypeEnum',
      'format': ''
    }];
...
export type SaveAnnotationDtoContentTypeEnum = 'Text' | 'AnnotJSON' | 'Textgrid';
