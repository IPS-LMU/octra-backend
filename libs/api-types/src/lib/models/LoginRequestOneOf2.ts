...
export class LoginRequestOneOf2 {
  'type': LoginRequestOneOf2TypeEnum;
  ...
  static getAttributeTypeMap() {
    return LoginRequestOneOf2.attributeTypeMap;
  }
...
export type LoginRequestOneOf2TypeEnum = 'shibboleth';
