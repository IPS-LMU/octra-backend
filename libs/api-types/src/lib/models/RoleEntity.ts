...
export class RoleEntity {
  'label'?: RoleEntityLabelEnum;
  'description'?: string;
  'scope': RoleEntityScopeEnum;
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    },
    {
      'name': 'scope',
      'baseName': 'scope',
      'type': 'RoleEntityScopeEnum',
      'format': ''
    }];

  static getAttributeTypeMap() {
    return RoleEntity.attributeTypeMap;
  }
...
export type RoleEntityLabelEnum =
  'administrator'
  | 'transcriber'
  | 'project_admin'
  | 'data_delivery'
  | 'public'
  | 'user';
export type RoleEntityScopeEnum = 'general' | 'project';
