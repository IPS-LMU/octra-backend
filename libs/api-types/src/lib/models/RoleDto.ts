...
export type RoleDtoRoleEnum = 'administrator' | 'transcriber' | 'project_admin' | 'data_delivery' | 'public' | 'user';
export type RoleDtoScopeEnum = 'general' | 'project';
