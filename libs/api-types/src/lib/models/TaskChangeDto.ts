...
import {TaskChangeDtoProperties} from './TaskChangeDtoProperties';
...
export class TaskChangeDto {
   ...
   */
  'transcriptType': TaskChangeDtoTranscriptTypeEnum;
  'transcript': TaskUploadDtoTranscript;
  /**
  ...
  static readonly attributeTypeMap: Array<{ name: string, baseName: string, type: string, format: string }> = [
    ...
    {
      'name': 'transcriptType',
      'baseName': 'transcriptType',
      'type': 'TaskChangeDtoTranscriptTypeEnum',
      'format': ''
    },
    {
      'name': 'transcript',
      'baseName': 'transcript',
      'type': 'TaskUploadDtoTranscript',
      'format': ''
    },
    {
      'name': 'inputs',
...
export type TaskChangeDtoTranscriptTypeEnum = 'Text' | 'AnnotJSON';
