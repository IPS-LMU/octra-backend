...
export type TaskPropertiesTypeEnum = 'annotation';
export type TaskPropertiesStatusEnum = 'DRAFT' | 'FREE' | 'BUSY' | 'FINISHED' | 'FAILED' | 'POSTPONED';
